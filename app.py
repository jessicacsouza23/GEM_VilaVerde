...
# ==========================================
    ...
    st.title("📊 Análise Pedagógica e Rodízio") # Verifique se aqui estava apenas t.title
    
    # Verificação de segurança para banco vazio
    ...
    if df.empty:
        ...
        # 2. PROCESSAMENTO DE DATAS (Protegido)
